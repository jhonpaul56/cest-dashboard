...
const NAV_ITEMS = [
  ...
  { id: "starbooks", icon: BookOpen, label: "Starbooks" },
    ...
    <>
      ...
      {showLogoutModal && (
        <>
          ...
          />
          <div 
            className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-md z-[60] animate-modal-bounce-in px-4"
