...
export const SettingsPage = ({ darkMode, setDarkMode, onClose }) => {
  ...
  return (
    <>
      ...
      {/* Settings Modal */}
      <div 
        className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-5xl max-h-[90vh] overflow-hidden rounded-2xl shadow-2xl z-50 animate-scale-in"
        style={{
